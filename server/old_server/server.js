...
const addChatToServer = require('./routes/chat.js')
...
async function start () {
    ...
    // const chatTing = await addChatToServer(pluginServer.server, pluginSocket)
    await addChatToServer(pluginServer.server, pluginSocket)
